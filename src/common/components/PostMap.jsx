...
export default function PostMap( { lostLocation }) {
  ...
  // console.log("lostLocation",lostLocation.lat,lostLocation.lon );
  ...
  useEffect(() => {
    ...
    if (window.kakao && window.kakao.maps) {
      ...
      const options = {
        center: new window.kakao.maps.LatLng(lostLocation.lat, lostLocation.lon), // 중심 좌표
        level: 3, // 확대 수준
      };
      ...
      // 마커 생성
      const markerPosition = new window.kakao.maps.LatLng(lostLocation.lat, lostLocation.lon); // 마커 위치
