...
const ReportDetailPage = () => {
  ...
  return (
    <Grid
      container
      spacing={0}
      sx={{ padding: '0 4%', fontFamily: 'Gmarket_light', marginTop: '1vh' }}
    >
      <Grid
        size={12}
        sx={{ width: '100%', display: 'flex', color: '#fff', fontFamily: 'KBO_medium' }}
      >
        <Box id="postnav" sx={{ background: ' #436850' }}>
          목격제보
        </Box>
        <Box id="postnav" sx={{ background: ' #5D9471' }}>
          {repTitle}
        </Box>
        <Box id="postnav" sx={{ background: ' #5D9471', marginLeft: 'auto' }} onClick={shareBtn}>
          공유 하기
        </Box>
      </Grid>
            ...
            <Grid size={{ xs: 12, sm: 4 }}>
              ...
              >
                ...
                >
                  ...
                  <h3>목격 당시 위치 </h3>
                  {pet?.sightedLocation.number_address}
                </Box>
              </Card>
            </Grid>
          </Grid>
