...
export default function PostMap( { lostLocation }) {
  ...
  useEffect(() => {
    ...
    if (window.kakao && window.kakao.maps) {
      ...
      const options = {
        center: new window.kakao.maps.LatLng(lostLocation.lat, lostLocation.lng), // 중심 좌표
        level: 3, // 확대 수준
      };
      ...
      // 마커 생성
      const markerPosition = new window.kakao.maps.LatLng(lostLocation.lat, lostLocation.lng); // 마커 위치
